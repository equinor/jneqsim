...
class constantDutyFlash(ConstantDutyFlashInterface):
    ...
    @typing.overload
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface): ...
    def addData(self, string: str, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> None: ...
    def displayResult(self) -> None: ...
    def get(self, string: str) -> typing.MutableSequence[float]: ...
    def getPoints(self, int: int) -> typing.MutableSequence[typing.MutableSequence[float]]: ...
    def getResultTable(self) -> typing.MutableSequence[typing.MutableSequence[str]]: ...
...
class FreezeOut(constantDutyTemperatureFlash, jneqsim.neqsim.thermo.ThermodynamicConstantsInterface):
    ...
    FCompNames: typing.MutableSequence[str] = ...
    noFreezeFlash: bool = ...
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface): ...
    def printToFile(self, string: str) -> None: ...
    def run(self) -> None: ...
...
class HydrateInhibitorConcentrationFlash(constantDutyTemperatureFlash):
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, string: str, double: float): ...
    @staticmethod
...
class addIonToScaleSaturation(constantDutyTemperatureFlash):
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, int: int, string: str, string2: str): ...
    def getResultTable(self) -> typing.MutableSequence[typing.MutableSequence[str]]: ...
    def printToFile(self, string: str) -> None: ...
    def run(self) -> None: ...
...
class calcSaltSatauration(constantDutyTemperatureFlash):
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, string: str): ...
    def printToFile(self, string: str) -> None: ...
    def run(self) -> None: ...
...
class freezingPointTemperatureFlash(constantDutyTemperatureFlash, jneqsim.neqsim.thermo.ThermodynamicConstantsInterface):
    ...
    def printToFile(self, string: str) -> None: ...
    @typing.overload
    def printToFile(self, string: str, stringArray: typing.Union[typing.List[str], jpype.JArray], doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
    def run(self) -> None: ...
