...
class NumericalDerivative(java.io.Serializable):
    ...
    @staticmethod
    def fugcoefDiffTemp(componentInterface: jneqsim.neqsim.thermo.component.ComponentInterface, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> float: ...
