...
class FlowSystemInterface:
    ...
    def getFileWriter(self, int: int) -> jneqsim.neqsim.fluidMechanics.util.fluidMechanicsDataHandeling.FileWriterInterface: ...
    ...
    def setFlowPattern(self, string: str) -> None: ...
