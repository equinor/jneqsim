...
class ControllerDeviceInterface(java.io.Serializable):
    ...
    def setTransmitter(self, measurementDeviceInterface: jneqsim.neqsim.processSimulation.measurementDevice.MeasurementDeviceInterface) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.neqsim.processSimulation.controllerDevice")``.
