...
class Fittings(java.io.Serializable):
    ...
    @typing.overload
    def add(self, string: str, double: float) -> None: ...
    def getFittingsList(self) -> java.util.ArrayList['Fittings.Fitting']: ...
    class Fitting(java.io.Serializable):
        @typing.overload
        def __init__(self, fittings: 'Fittings', string: str): ...
        @typing.overload
        def __init__(self, fittings: 'Fittings', string: str, double: float): ...
        def getFittingName(self) -> str: ...
        def getLtoD(self) -> float: ...
        def setFittingName(self, string: str) -> None: ...
        def setLtoD(self, double: float) -> None: ...

class PipeLineInterface(jneqsim.neqsim.processSimulation.SimulationInterface, jneqsim.neqsim.processSimulation.processEquipment.TwoPortInterface):
    ...
    def setInitialFlowPattern(self, string: str) -> None: ...
...
class Pipeline(jneqsim.neqsim.processSimulation.processEquipment.TwoPortEquipment, PipeLineInterface):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    ...
    def getMechanicalDesign(self) -> jneqsim.neqsim.processSimulation.mechanicalDesign.pipeline.PipelineMechanicalDesign: ...
    def getPipe(self) -> jneqsim.neqsim.fluidMechanics.flowSystem.FlowSystemInterface: ...
...
class AdiabaticPipe(Pipeline):
    ...
    def setPipeSpecification(self, double: float, string: str) -> None: ...
    @typing.overload
...
class AdiabaticTwoPhasePipe(Pipeline):
    ...
    def run(self, uUID: java.util.UUID) -> None: ...
    def setDiameter(self, double: float) -> None: ...
    def setFlowLimit(self, double: float, string: str) -> None: ...
    def setInitialFlowPattern(self, string: str) -> None: ...
    def setInletElevation(self, double: float) -> None: ...
    def setLength(self, double: float) -> None: ...
    def setOutPressure(self, double: float) -> None: ...
...
class PipeBeggsAndBrills(Pipeline):
    ...
    def getFlowRegime(self) -> str: ...
    def getFlowRegimeProfile(self) -> java.util.List[str]: ...
    ...
    def getSegmentFlowRegime(self, int: int) -> str: ...
...
class IncompressiblePipeFlow(AdiabaticPipe):
    ...
    @typing.overload
    def __init__(self, streamInterface: jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface): ...
    def addFitting(self, string: str, double: float) -> None: ...
    def addFittingFromDatabase(self, string: str) -> None: ...
    def calcPressureOut(self) -> float: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.neqsim.processSimulation.processEquipment.pipeline")``.
