...
class ComponentInterface(jneqsim.neqsim.thermo.ThermodynamicConstantsInterface, java.lang.Cloneable):
    ...
    def createComponent(self, string: str, double: float, double2: float, int: int) -> None: ...
    ...
    def getAssociationScheme(self) -> str: ...
    ...
    @staticmethod
    def getComponentNameFromAlias(string: str) -> str: ...
    @staticmethod
    def getComponentNameMap() -> java.util.LinkedHashMap[str, str]: ...
    def getComponentNumber(self) -> int: ...
    def getComponentType(self) -> str: ...
    ...
    def getIdealGasGibsEnergyOfFormation(self) -> float: ...
    ...
    def getRate(self, string: str) -> float: ...
    def getReferencePotential(self) -> float: ...
    def getReferenceStateType(self) -> str: ...
    ...
    def insertComponentIntoDatabase(self, string: str) -> None: ...
    ...
    def setAssociationScheme(self, string: str) -> None: ...
    ...
    def setFormulae(self, string: str) -> None: ...
...
class Component(ComponentInterface):
    ...
    @typing.overload
    def __init__(self, string: str, double: float, double2: float, int: int): ...
    def Finit(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, double: float, double2: float, double3: float, double4: float, int: int, int2: int) -> None: ...
    @typing.overload
    def addMolesChemReac(self, double: float) -> None: ...
    @typing.overload
...
class ComponentDesmukhMather(ComponentGE):
    ...
    def fugcoef(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray3: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], stringArray: typing.Union[typing.List[typing.MutableSequence[str]], jpype.JArray]) -> float: ...
    @typing.overload
    def getGamma(self) -> float: ...
...
class ComponentGEUniquac(ComponentGE):
    ...
    def fugcoef(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoef(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> float: ...
    @typing.overload
    def fugcoefDiffPres(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoefDiffPres(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> float: ...
    @typing.overload
    def fugcoefDiffTemp(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoefDiffTemp(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> float: ...
    @typing.overload
    def getGamma(self) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> float: ...
...
class ComponentGeDuanSun(ComponentGE):
    ...
    def getGamma(self) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray3: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], stringArray: typing.Union[typing.List[typing.MutableSequence[str]], jpype.JArray]) -> float: ...
    def getGammaNRTL(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> float: ...
    def getGammaPitzer(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int, double3: float) -> float: ...
    def getLngamma(self) -> float: ...
    def getq(self) -> float: ...
    def getr(self) -> float: ...
...
class ComponentGEUnifacUMRPRU(ComponentGEUnifac):
    def __init__(self, string: str, double: float, double2: float, int: int): ...
    def calcGammaNumericalDerivatives(self, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> None: ...
