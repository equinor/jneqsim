...
class EosMixingRules(java.lang.Cloneable, jneqsim.neqsim.thermo.ThermodynamicConstantsInterface):
    ...
    def displayInteractionCoefficients(self, string: str, phaseInterface: jneqsim.neqsim.thermo.phase.PhaseInterface) -> None: ...
    def getClassicOrHV(self) -> typing.MutableSequence[typing.MutableSequence[str]]: ...
    def getClassicOrWS(self) -> typing.MutableSequence[typing.MutableSequence[str]]: ...
    ...
    def setCalcEOSInteractionParameters(self, boolean: bool) -> None: ...
    def setMixingRuleGEModel(self, string: str) -> None: ...
    def setMixingRuleName(self, string: str) -> None: ...
