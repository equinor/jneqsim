...
class Splitter(jneqsim.neqsim.processSimulation.processEquipment.ProcessEquipmentBaseClass, SplitterInterface):
    ...
    def __init__(self, string: str, streamInterface: jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface): ...
    @typing.overload
    def __init__(self, string: str, streamInterface: jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface, int: int): ...
    @typing.overload
    ...
    @typing.overload
    def run(self, uUID: java.util.UUID) -> None: ...
    def setFlowRates(self, doubleArray: typing.Union[typing.List[float], jpype.JArray], string: str) -> None: ...
    def setInletStream(self, streamInterface: jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface) -> None: ...
    def setSplitFactors(self, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
    def setSplitNumber(self, int: int) -> None: ...
