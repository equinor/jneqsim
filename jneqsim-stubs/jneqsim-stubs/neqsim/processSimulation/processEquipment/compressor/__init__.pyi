...
class CompressorChartGenerator:
    ...
    def generateCompressorChart(self, string: str) -> 'CompressorChart': ...
...
class CompressorChartInterface(java.lang.Cloneable):
    ...
    def setHeadUnit(self, string: str) -> None: ...
...
class Compressor(jneqsim.neqsim.processSimulation.processEquipment.TwoPortEquipment, CompressorInterface):
    ...
    @typing.overload
    def getPolytropicHead(self, string: str) -> float: ...
    def getPolytropicHeadMeter(self) -> float: ...
    def getPolytropicMethod(self) -> str: ...
    @typing.overload
    ...
    @typing.overload
    def setOutletPressure(self, double: float, string: str) -> None: ...
    def setPolytropicEfficiency(self, double: float) -> None: ...
    def setPolytropicHeadMeter(self, double: float) -> None: ...
    def setPolytropicMethod(self, string: str) -> None: ...
