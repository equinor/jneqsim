...
class MechanicalDesign(java.io.Serializable):
    ...
    def getCompanySpecificDesignStandards(self) -> str: ...
    def getConstrutionMaterial(self) -> str: ...
    ...
    def getDesignStandard(self) -> java.util.Hashtable[str, jneqsim.neqsim.processSimulation.mechanicalDesign.designStandards.DesignStandard]: ...
    ...
    def setCompanySpecificDesignStandards(self, string: str) -> None: ...
    def setConstrutionMaterial(self, string: str) -> None: ...
    def setCorrosionAllowanse(self, double: float) -> None: ...
    def setDesign(self) -> None: ...
    def setDesignStandard(self, hashtable: java.util.Hashtable[str, jneqsim.neqsim.processSimulation.mechanicalDesign.designStandards.DesignStandard]) -> None: ...
...
class SystemMechanicalDesign(java.io.Serializable):
    ...
    def equals(self, object: typing.Any) -> bool: ...
    def getMechanicalWeight(self, string: str) -> float: ...
