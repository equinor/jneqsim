...
class dTPflash(TPflash):
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, stringArray: typing.Union[typing.List[str], jpype.JArray]): ...
    def run(self) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    TPmultiflash_1: typing.Type[TPmultiflash_1]
