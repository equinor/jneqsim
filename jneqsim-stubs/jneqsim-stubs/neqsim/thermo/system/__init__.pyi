...
class SystemInterface(java.lang.Cloneable, java.io.Serializable):
    ...
    def addCapeOpenProperty(self, string: str) -> None: ...
    def addCharacterized(self, stringArray: typing.Union[typing.List[str], jpype.JArray], doubleArray: typing.Union[typing.List[float], jpype.JArray], doubleArray2: typing.Union[typing.List[float], jpype.JArray], doubleArray3: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def addComponent(self, string: str, double: float) -> None: ...
    @typing.overload
    def addComponent(self, string: str, double: float, double2: float, double3: float, double4: float) -> None: ...
    @typing.overload
    def addComponent(self, string: str, double: float, int: int) -> None: ...
    @typing.overload
    def addComponent(self, string: str, double: float, string2: str) -> None: ...
    @typing.overload
    def addComponent(self, string: str, double: float, string2: str, int: int) -> None: ...
    @typing.overload
    def addComponent(self, componentInterface: jneqsim.neqsim.thermo.component.ComponentInterface) -> None: ...
    @typing.overload
    def addComponents(self, stringArray: typing.Union[typing.List[str], jpype.JArray]) -> None: ...
    @typing.overload
    def addComponents(self, stringArray: typing.Union[typing.List[str], jpype.JArray], doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def addOilFractions(self, stringArray: typing.Union[typing.List[str], jpype.JArray], doubleArray: typing.Union[typing.List[float], jpype.JArray], doubleArray2: typing.Union[typing.List[float], jpype.JArray], doubleArray3: typing.Union[typing.List[float], jpype.JArray], boolean: bool) -> None: ...
    @typing.overload
    def addOilFractions(self, stringArray: typing.Union[typing.List[str], jpype.JArray], doubleArray: typing.Union[typing.List[float], jpype.JArray], doubleArray2: typing.Union[typing.List[float], jpype.JArray], doubleArray3: typing.Union[typing.List[float], jpype.JArray], boolean: bool, boolean2: bool, int: int) -> None: ...
    def addPhase(self) -> None: ...
    @typing.overload
    def addPhaseFractionToPhase(self, double: float, string: str, string2: str, string3: str) -> None: ...
    @typing.overload
    def addPhaseFractionToPhase(self, double: float, string: str, string2: str, string3: str, string4: str) -> None: ...
    def addPlusFraction(self, string: str, double: float, double2: float, double3: float) -> None: ...
    def addSalt(self, string: str, double: float) -> None: ...
    def addSolidComplexPhase(self, string: str) -> None: ...
    @typing.overload
    def addTBPfraction(self, string: str, double: float, double2: float, double3: float) -> None: ...
    @typing.overload
    def addTBPfraction(self, string: str, double: float, double2: float, double3: float, double4: float, double5: float, double6: float) -> None: ...
    def addToComponentNames(self, string: str) -> None: ...
    @typing.overload
    ...
    def calcBeta(self) -> float: ...
    def calcHenrysConstant(self, string: str) -> float: ...
    def calcInterfaceProperties(self) -> None: ...
    def calcKIJ(self, boolean: bool) -> None: ...
    def calcResultTable(self) -> typing.MutableSequence[typing.MutableSequence[str]]: ...
    def calc_x_y(self) -> None: ...
    def calc_x_y_nonorm(self) -> None: ...
    def changeComponentName(self, string: str, string2: str) -> None: ...
    @typing.overload
    ...
    def getCASNumbers(self) -> typing.MutableSequence[str]: ...
    def getCapeOpenProperties10(self) -> typing.MutableSequence[str]: ...
    def getCapeOpenProperties11(self) -> typing.MutableSequence[str]: ...
    ...
    def getCompFormulaes(self) -> typing.MutableSequence[str]: ...
    def getCompIDs(self) -> typing.MutableSequence[str]: ...
    def getCompNames(self) -> typing.MutableSequence[str]: ...
    @typing.overload
    def getComponent(self, int: int) -> jneqsim.neqsim.thermo.component.ComponentInterface: ...
    @typing.overload
    def getComponent(self, string: str) -> jneqsim.neqsim.thermo.component.ComponentInterface: ...
    def getComponentNameTag(self) -> str: ...
    def getComponentNames(self) -> typing.MutableSequence[str]: ...
    @typing.overload
    def getConductivity(self) -> float: ...
    @typing.overload
    def getConductivity(self, string: str) -> float: ...
    def getCorrectedVolume(self) -> float: ...
    def getCorrectedVolumeFraction(self, int: int) -> float: ...
    @typing.overload
    def getCp(self) -> float: ...
    @typing.overload
    def getCp(self, string: str) -> float: ...
    @typing.overload
    def getCv(self) -> float: ...
    @typing.overload
    def getCv(self, string: str) -> float: ...
    @typing.overload
    def getDensity(self) -> float: ...
    @typing.overload
    def getDensity(self, string: str) -> float: ...
    def getEmptySystemClone(self) -> 'SystemInterface': ...
    @typing.overload
    def getEnthalpy(self) -> float: ...
    @typing.overload
    def getEnthalpy(self, string: str) -> float: ...
    @typing.overload
    def getEntropy(self) -> float: ...
    @typing.overload
    def getEntropy(self, string: str) -> float: ...
    @typing.overload
    def getExergy(self, double: float) -> float: ...
    @typing.overload
    def getExergy(self, double: float, string: str) -> float: ...
    def getFlowRate(self, string: str) -> float: ...
    def getFluidInfo(self) -> str: ...
    ...
    def getIdealLiquidDensity(self, string: str) -> float: ...
    def getInitType(self) -> int: ...
    @typing.overload
    def getInterfacialTension(self, int: int, int2: int) -> float: ...
    @typing.overload
    def getInterfacialTension(self, int: int, int2: int, string: str) -> float: ...
    @typing.overload
    def getInterfacialTension(self, string: str, string2: str) -> float: ...
    @typing.overload
    def getInternalEnergy(self) -> float: ...
    @typing.overload
    def getInternalEnergy(self, string: str) -> float: ...
    ...
    @typing.overload
    def getJouleThomsonCoefficient(self, string: str) -> float: ...
    def getKappa(self) -> float: ...
    @typing.overload
    def getKinematicViscosity(self) -> float: ...
    @typing.overload
    def getKinematicViscosity(self, string: str) -> float: ...
    ...
    def getMixingRule(self) -> int: ...
    def getMixingRuleName(self) -> str: ...
    def getModelName(self) -> str: ...
    def getMolarComposition(self) -> typing.MutableSequence[float]: ...
    @typing.overload
    def getMolarMass(self) -> float: ...
    @typing.overload
    def getMolarMass(self, string: str) -> float: ...
    ...
    @typing.overload
    def getPhase(self, string: str) -> jneqsim.neqsim.thermo.phase.PhaseInterface: ...
    @typing.overload
    def getPhase(self, phaseType: jneqsim.neqsim.thermo.phase.PhaseType) -> jneqsim.neqsim.thermo.phase.PhaseInterface: ...
    def getPhaseFraction(self, string: str, string2: str) -> float: ...
    @typing.overload
    def getPhaseIndex(self, int: int) -> int: ...
    @typing.overload
    def getPhaseIndex(self, string: str) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def getPhaseNumberOfPhase(self, string: str) -> int: ...
    def getPhaseOfType(self, string: str) -> jneqsim.neqsim.thermo.phase.PhaseInterface: ...
    ...
    @typing.overload
    def getProperty(self, string: str) -> float: ...
    @typing.overload
    def getProperty(self, string: str, int: int) -> float: ...
    @typing.overload
    def getProperty(self, string: str, string2: str, int: int) -> float: ...
    def getResultTable(self) -> typing.MutableSequence[typing.MutableSequence[str]]: ...
    @typing.overload
    def getSoundSpeed(self) -> float: ...
    @typing.overload
    def getSoundSpeed(self, string: str) -> float: ...
    @typing.overload
    def getStandard(self) -> jneqsim.neqsim.standards.StandardInterface: ...
    @typing.overload
    def getStandard(self, string: str) -> jneqsim.neqsim.standards.StandardInterface: ...
    ...
    @typing.overload
    def getTemperature(self, string: str) -> float: ...
    @typing.overload
    def getThermalConductivity(self) -> float: ...
    @typing.overload
    def getThermalConductivity(self, string: str) -> float: ...
    def getTotalNumberOfMoles(self) -> float: ...
    @typing.overload
    def getViscosity(self) -> float: ...
    @typing.overload
    def getViscosity(self, string: str) -> float: ...
    @typing.overload
    def getVolume(self) -> float: ...
    @typing.overload
    def getVolume(self, string: str) -> float: ...
    ...
    @typing.overload
    def hasPhaseType(self, string: str) -> bool: ...
    ...
    @typing.overload
    def initPhysicalProperties(self, string: str) -> None: ...
    ...
    @typing.overload
    def phaseToSystem(self, string: str) -> 'SystemInterface': ...
    @typing.overload
    ...
    def readFluid(self, string: str) -> None: ...
    def readObject(self, int: int) -> 'SystemInterface': ...
    def readObjectFromFile(self, string: str, string2: str) -> 'SystemInterface': ...
    def removeComponent(self, string: str) -> None: ...
    def removeMoles(self) -> None: ...
    def removePhase(self, int: int) -> None: ...
    def removePhaseKeepTotalComposition(self, int: int) -> None: ...
    def renameComponent(self, string: str, string2: str) -> None: ...
    ...
    @typing.overload
    def saveFluid(self, int: int, string: str) -> None: ...
    def saveObject(self, int: int, string: str) -> None: ...
    def saveObjectToFile(self, string: str, string2: str) -> None: ...
    ...
    def setComponentNameTag(self, string: str) -> None: ...
    def setComponentNameTagOnNormalComponents(self, string: str) -> None: ...
    def setComponentNames(self, stringArray: typing.Union[typing.List[str], jpype.JArray]) -> None: ...
    def setEmptyFluid(self) -> None: ...
    def setFluidInfo(self, string: str) -> None: ...
    def setFluidName(self, string: str) -> None: ...
    ...
    @typing.overload
    def setMixingRule(self, string: str) -> None: ...
    @typing.overload
    def setMixingRule(self, string: str, string2: str) -> None: ...
    def setModel(self, string: str) -> 'SystemInterface': ...
    ...
    @typing.overload
    def setPhaseType(self, string: str, int: int) -> None: ...
    @typing.overload
    def setPhaseType(self, int: int, int2: int) -> None: ...
    @typing.overload
    def setPhaseType(self, int: int, string: str) -> None: ...
    ...
    @typing.overload
    def setSolidPhaseCheck(self, string: str) -> None: ...
    def setStandard(self, string: str) -> None: ...
...
class SystemThermo(SystemInterface):
    ...
    @typing.overload
    def setMixingRule(self, string: str, string2: str) -> None: ...
    def setMixingRuleGEmodel(self, string: str) -> None: ...
    def setModel(self, string: str) -> SystemInterface: ...
...
class SystemPrEos1978(SystemEos):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
